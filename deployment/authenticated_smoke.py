...
async def run_authenticated_smoke(
    ...
    *,
    ...
    cloudflare_scheduler_running: bool = True,
) -> dict[str, Any]:
    ...
    try:
        ...
        checks.extend(_verify_operational_reads(
            ...
            token,
            "cloudflare",
            expected_scheduler_running=cloudflare_scheduler_running,
        ))
...
def main() -> int:
    ...
    parser.add_argument("--cloudflare-scheduler-stopped", action="store_true")
    ...
    report = asyncio.run(run_authenticated_smoke(
        render_url,
        cloudflare_url,
        token,
        cloudflare_scheduler_running=not args.cloudflare_scheduler_stopped,
    ))
